...
export const Strings={
  ...
  BACKEND_ERROR: "Ha ocurrido un error",
  ...
  MAKE_LOGIN_TITLE: "Iniciar Sesión",
  ...
  EXPIRED_SPACE_TITLE: "Espacio no disponible",
  EXPIRED_SPACE_DESC: "El espacio seleccionado ya no se encuentra disponible. Los espacios disponibles son los que están dentro de un recuadro café."
}

export const CSS_CLASSES={
  CELL_RESERVED:"cell_reserved",
  STANDARD_CELL:"cell",
  EXPIRED_CELL:"expired_cell"
}
...
export const ASSETS = {
  FAILED_ICON: '../../../assets/img/failed_icon.png',
  SUCCESS_ICON: '../../../assets/img/success_icon.png',
  INFORM_ICON: '../../../assets/img/inform_icon.png',
}